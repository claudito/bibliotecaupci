...
$tipo_usuarios       = new Tipo_usuarios('?');
$turnos              = new Turnos('?');
$especialidad        = new Especialidades('?','?');  
$lista_tipo_usuarios = $tipo_usuarios->lista();
$lista_turnos        = $turnos->lista();
$lista_especialidad  = $especialidad->lista();
 ?>
<!DOCTYPE html>
<html lang="es">
  <head>
  ...
  <body>
  <?php include("../modal/usuarios/modal_agregar.php");?>
  <?php include("../modal/usuarios/modal_eliminar.php"); ?>
  <?php include("../modal/usuarios/modal_modificar.php"); ?>
