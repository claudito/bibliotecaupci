	function load(page){
		...
		$("#loader").fadeIn('slow');
		$.ajax({
			url:'../modal/palabras_clave/grid.php',
			data: parametros,
  ...
  var descripcion = button.data('descripcion') // Extraer la información de atributos de datos
		  ...
		  var modal = $(this)
		  modal.find('.modal-title').text('Modificar Palabra Clave: '+descripcion)
	...
	$( "#actualidarDatos" ).submit(function( event ) {
		var parametros = $(this).serialize();
			 $.ajax({
					type: "POST",
					url: "../procesos/palabras_clave/modificar.php",
					data: parametros,
					 beforeSend: function(objeto){
		...
		var parametros = $(this).serialize();
			 $.ajax({
					type: "POST",
					url: "../procesos/palabras_clave/agregar.php",
					data: parametros,
					 beforeSend: function(objeto){
						$(".datos_ajax").html("Mensaje: Cargando...");
					  },
		...
		var parametros = $(this).serialize();
			 $.ajax({
					type: "POST",
					url: "../procesos/palabras_clave/eliminar.php",
					data: parametros,
					 beforeSend: function(objeto){
						$(".datos_ajax").html("Mensaje: Cargando...");
					  },
