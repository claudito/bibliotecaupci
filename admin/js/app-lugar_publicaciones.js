	function load(page){
		...
		$("#loader").fadeIn('slow');
		$.ajax({
			url:'../modal/lugar_publicaciones/grid.php',
			data: parametros,
  ...
  var descripcion = button.data('descripcion') // Extraer la información de atributos de datos
		  ...
		  var modal = $(this)
		  modal.find('.modal-title').text('Modificar Lugar de Publicación: '+descripcion)
	...
	$( "#actualidarDatos" ).submit(function( event ) {
		var parametros = $(this).serialize();
			 $.ajax({
					type: "POST",
					url: "../procesos/lugar_publicaciones/modificar.php",
					data: parametros,
					 beforeSend: function(objeto){
		...
		var parametros = $(this).serialize();
			 $.ajax({
					type: "POST",
					url: "../procesos/lugar_publicaciones/agregar.php",
					data: parametros,
					 beforeSend: function(objeto){
						$(".datos_ajax").html("Mensaje: Cargando...");
					  },
		...
		var parametros = $(this).serialize();
			 $.ajax({
					type: "POST",
					url: "../procesos/lugar_publicaciones/eliminar.php",
					data: parametros,
					 beforeSend: function(objeto){
						$(".datos_ajax").html("Mensaje: Cargando...");
					  },
