	function load(page){
		...
		$("#loader").fadeIn('slow');
		$.ajax({
			url:'../modal/tipo-autores/grid.php',
			data: parametros,
  ...
  var descripcion = button.data('descripcion') // Extraer la información de atributos de datos
		  ...
		  var modal = $(this)
		  modal.find('.modal-title').text('Modificar Tipo de Autor: '+descripcion)
	...
	$( "#actualidarDatos" ).submit(function( event ) {
		var parametros = $(this).serialize();
			 $.ajax({
					type: "POST",
					url: "../procesos/tipo-autores/modificar.php",
					data: parametros,
					 beforeSend: function(objeto){
		...
		var parametros = $(this).serialize();
			 $.ajax({
					type: "POST",
					url: "../procesos/tipo-autores/agregar.php",
					data: parametros,
					 beforeSend: function(objeto){
						$(".datos_ajax").html("Mensaje: Cargando...");
					  },
		...
		var parametros = $(this).serialize();
			 $.ajax({
					type: "POST",
					url: "../procesos/tipo-autores/eliminar.php",
					data: parametros,
					 beforeSend: function(objeto){
						$(".datos_ajax").html("Mensaje: Cargando...");
					  },
