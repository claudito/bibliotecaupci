  ...
  var descripcion = button.data('descripcion') // Extraer la información de atributos de datos
		  ...
		  var modal = $(this)
		  modal.find('.modal-title').text('Modificar Cabina: '+descripcion)
	...
	$( "#actualidarDatos" ).submit(function( event ) {
		var parametros = $(this).serialize();
			 $.ajax({
					type: "POST",
					url: "../procesos/cabinas/modificar.php",
					data: parametros,
					 beforeSend: function(objeto){
		...
		var parametros = $(this).serialize();
			 $.ajax({
					type: "POST",
					url: "../procesos/cabinas/agregar.php",
					data: parametros,
					 beforeSend: function(objeto){
						$(".datos_ajax").html("Mensaje: Cargando...");
					  },
		...
		var parametros = $(this).serialize();
			 $.ajax({
					type: "POST",
					url: "../procesos/cabinas/eliminar.php",
					data: parametros,
					 beforeSend: function(objeto){
						$(".datos_ajax").html("Mensaje: Cargando...");
					  },
